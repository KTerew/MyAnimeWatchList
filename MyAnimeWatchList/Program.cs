...
using AnimeWatchList.Services.BusinessLogic;
using AnimeWatchList.Services.BusinessLogic.IServices;
using AnimeWatchList.Services.Configurations;
...
using MyAnimeWatchList.Areas.Identity;
using MyAnimeWatchList.Data;
...
builder.Services.AddScoped<IEpisodeTrackerServices, EpisodeTrackerServices>();
